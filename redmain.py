...
with multiprocessing.Manager() as manager: 
	...
	while True:
		...
		print(snd1['draw'][0], snd2['draw'][0], player_1.player_coord)
		if(snd1['draw'][0] == player_1.player_coord or snd2['draw'][0] == player_1.player_coord):
			print("lives: ", player_1.lives)
